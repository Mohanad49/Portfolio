...
const WORDS = ["Software QA Engineer", "Test Automation Expert"];
const TECH_STACK = ["Python", "Selenium", "PyTest", "Appium"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Mohanad49" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/mohanad49/" },
  { icon: Instagram, link: "https://www.instagram.com/mohanned_yehia/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Ensuring End-to-End Quality Assurance and Reliable Automated Testing Solutions.
                </p>
