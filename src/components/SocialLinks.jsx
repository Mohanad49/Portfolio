...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mohanad49",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@mohanned _yehia",
    icon: Instagram,
    url: "https://www.instagram.com/mohanned_yehia/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Mohanad Yehia",
    icon: Youtube,
    url: "https://www.youtube.com/@mohannedyehia4397",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@Mohanad 49",
    icon: Github,
    url: "https://github.com/Mohanad49",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@mohanad.yehia",
    color: "black",
...
>
  ...
  <div className="relative flex items-center gap-4">
    ...
    <div className="flex flex-col flex-1 min-w-0">
      ...
      <span className="text-sm text-gray-400 group-hover:text-gray-300 transition-colors duration-300 whitespace-normal">
        {linkedIn.subText}
      </span>
    </div>
  </div>
          ...
          {[instagram, youtube].map((link) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 min-w-0">
                ...
                <span className="text-xs text-gray-400 group-hover:text-gray-300 transition-colors duration-300 whitespace-normal overflow-hidden">
                  {link.subText}
                </span>
              </div>
